...
- `/` and `/api/*` for a browser interface: commission devices, view them,
  filter and search them by room, name them, switch them, export templates,
  diagnostics.
...
[webui-updates design, section 8](superpowers/specs/2026-09-08-webui-updates-design.md#8-the-updater-flow).
